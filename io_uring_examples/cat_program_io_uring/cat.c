...
int app_setup_uring(struct submitter* s) {
     ...
     * buffers, which can be jointly mapped with a single mmap() call in recent
     * kernels. While the completion queue is directly manipulated, the
    ...
    /* Save useful fields in a global app_io_s    loginctl terminate-user $USER
     * loginctl terminate-user $USERq_ring struct for later easy reference */
